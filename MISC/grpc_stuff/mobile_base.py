...
class MobileBaseMobilityServicer(mobile_base_mobility_pb2_grpc.MobileBaseMobilityServiceServicer):
    ...
    def get_mobile_base(self, context: grpc.ServicerContext) -> MobileBase:
        ...
        if self.mobile_base_enabled:
            return MobileBase(
                ...
                info=PartInfo(serial_number="MUJOCO", version_hard="MUJOCO", version_soft="MUJOCO"),
            )
        else:
            return None
